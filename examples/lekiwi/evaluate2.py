...
EPISODE_TIME_SEC = 0
RESET_TIME_SEC = 10
TASK_DESCRIPTION = "Pick white object2"
#HF_MODEL_ID = "astroyat/act_pickwhiteobject2"
HF_MODEL_ID = "astroyat/smolvla_pickwhiteobject2"
HF_REPO_ID = "astroyat/eval_pickwhiteobject2"

# Create the robot and teleoperator configurations
robot_config = LeKiwiClientConfig(remote_ip="10.0.0.71", id="lekiwi")
